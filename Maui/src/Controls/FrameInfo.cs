...
namespace Global.InputForms
{
    ...
    public class FrameInfo : StackLayout
    {
        ...
        public static readonly BindableProperty InfoColorProperty =
            BindableProperty.Create(nameof(InfoColor), typeof(Color), typeof(FrameInfo), Colors.Red,
        ...
        public FrameInfo()
        {
            ...
            _frameLayout = new Frame
            {
                ...
                CornerRadius = 5,
                BorderColor = Info ? InfoColor : Colors.Transparent,
                HasShadow = false,
        ...
        public bool InfoIsVisible
        {
            ...
            set
            {
                ...
                _frameLayout.BorderColor = value ? InfoColor : Colors.Transparent;
            }
        }
        ...
        private static void InfoIsVisibleChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            frameInfo._frameLayout.BorderColor = (bool) newValue ? frameInfo.InfoColor : Colors.Transparent;
        }
