...
namespace Global.InputForms
{
    public class Switch : Grid
    {
        ...
        public static readonly BindableProperty SwitchColorProperty = BindableProperty.Create(nameof(SwitchColor),
            typeof(Color), typeof(Switch), Colors.Navy);
        ...
        public new static readonly BindableProperty BackgroundColorProperty = BindableProperty.Create(
            ...
            typeof(Color), typeof(Switch), Colors.Yellow);
        ...
        public Switch()
        {
            ...
            Children.Add(_backgroundFrame); //Todo overload (0,0)

            _backgroundFrame.SetBinding(Microsoft.Maui.Controls.Frame.CornerRadiusProperty,
            ...
            _backgroundFrame.SetBinding(Microsoft.Maui.Controls.Frame.BorderColorProperty,
                new Binding(nameof(BackgroundColor)) { Source = this, Mode = BindingMode.OneWay });
            ...
            SwitchFrame.SetBinding(Microsoft.Maui.Controls.Frame.CornerRadiusProperty,
            ...
            SwitchFrame.SetBinding(Microsoft.Maui.Controls.Frame.BorderColorProperty,
                new Binding(nameof(SwitchColor)) { Source = this, Mode = BindingMode.OneWay });

            Children.Add(SwitchFrame); //Todo overload (0,0)
